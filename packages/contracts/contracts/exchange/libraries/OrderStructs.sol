...
enum SignatureType {
    ...
    EOA
    // 1: EIP712 signatures signed by EOAs that own Polymarket Proxy wallets - REMOVED
    // 2: EIP712 signatures signed by EOAs that own Polymarket Gnosis safes - REMOVED
}
